...
import { storage,app,auth } from "../js/firebase-config.js";
...
async function collectServicesFormData() {
	...
	for (const serviceElement of serviceElements) {
	  const serviceImageInput = serviceElement.querySelector("input[type='file']");
	  let serviceImageUrl;
  
	  const serviceTitleInput = serviceElement.querySelector("input[placeholder='Service Title']");
	  const serviceDescInput = serviceElement.querySelector("input[placeholder='Service Description']");
