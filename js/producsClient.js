...
async function populateTable(searchTerm) {
    ...
    try {
        const snapshot = await getDoc(clientProductRef);
        ...
        showMessage("Error fetching clients: " + error.message);
    }
}
